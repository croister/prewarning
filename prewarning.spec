...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'urllib.error',
        'urllib.request',
        'startlistsources.start_list_source_file',
        'startlistsources.start_list_source_ola_mysql',
        'startlistsources._base',
        'punchsources.punch_source_ola_mysql',
        'punchsources.punch_source_olresultat_se',
        'punchsources._base',
    ],
    hookspath=[],
    hooksconfig={},
