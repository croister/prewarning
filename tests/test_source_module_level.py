...
class TestPunchSourcesModule:
    ...
    def test_default_value_is_known_source(self):
        assert (
            punchsources.COMMON_PUNCH_SOURCE.default_value in punchsources.PUNCH_SOURCES
        )
...
class TestStartListSourcesModule:
    ...
    def test_COMMON_START_LIST_SOURCE_is_ConfigOptionDefinition(self):
        ...
        assert isinstance(
            startlistsources.COMMON_START_LIST_SOURCE, ConfigOptionDefinition
        )
    ...
    def test_COMMON_START_LIST_SOURCE_properties(self):
        ...
        assert c.mandatory is True
        assert sorted(c.valid_values) == sorted(
            startlistsources.START_LIST_SOURCES.keys()
        )
    ...
    def test_default_value_is_known_source(self):
        assert (
            startlistsources.COMMON_START_LIST_SOURCE.default_value
            in startlistsources.START_LIST_SOURCES
        )
